...
public class ChoiceAdapter extends RecyclerView.Adapter<ChoiceAdapter.ChoiceHolder> {
    ...
    private ChoiceAdapter.ChoiceHolder mChoiceHolderSelected = null;
    private ITriger<Choice> triger;
    private Boolean showAnswers = false;

    public ChoiceAdapter(ArrayList<Choice> choices, ITriger<Choice> triger, Boolean showAnswers) {
    ...
    @Override
    public ChoiceAdapter.ChoiceHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(final ChoiceAdapter.ChoiceHolder holder, final int position) {
        ...
        if(mChoiceHolderSelected != null){
            mChoiceHolderSelected.setChecked(true);
        }
